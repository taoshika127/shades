            ...
            <div className="space-y-7 text-brown max-w-3xl mx-auto" style={bodyStyle}>
              ...
              <section>
                ...
                <p className="m-0 leading-relaxed mt-4">
                  With my background in the building industry and experience working across design, construction, and operations, I was able to build a business model that leverages both my expertise and network. By integrating technology and AI tools into my workflow—ranging from design support, vibe coding, content creation, and scheduling to cost estimation and marketing. This allows me to reduce unnecessary costs such as showroom expenses, excessive marketing spend, and administrative inefficiencies, and pass those savings directly to my clients.
                </p>
