  ...
  return (
    <footer className="bg-gray-100 border-t border-gray-100 py-10 md:py-20 px-5 md:px-20">
      <div className="max-w-container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row gap-8 md:gap-15 lg:gap-20 mb-10 lg:justify-between">
          ...
          <div className="flex flex-col gap-6 lg:w-auto lg:flex-shrink-0">
            <ul className="list-none p-0 m-0 flex flex-col gap-4">
              ...
              <li><a href="/#faq" className="text-brown no-underline text-base hover:text-primary transition-colors font-[500]" style={{ fontFamily: 'Montserrat, sans-serif' }}>FAQ</a></li>
            </ul>
          </div>
        </div>
