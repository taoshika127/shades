    ...
    <section className="w-full h-screen max-h-[100vh] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full max-h-[100vh] flex items-center justify-center md:justify-start px-5 md:px-20 overflow-hidden">
        <div className="max-w-container w-full flex justify-center md:justify-start">
          <div className="bg-light-beige p-6 md:p-10 relative top-[-20px] rounded-[10px] max-w-full md:max-w-[643px] md:ml-20">
            <p className="text-lg md:text-xl mb-4 font-weight-[400] text-[#5c4717]">We <span className="font-bold">customize</span>, <span className="font-bold">measure</span> and <span className="font-bold">install</span></p>
            <h2 className="text-2xl md:text-4xl font-bold text-primary leading-tight m-0 mb-6">Shades that fit your lifestyle and your budget</h2>
            ...
            <ul className="space-y-3 mb-6">
              {[
                ...
                <li key={index} className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#5c4717]
 flex items-center justify-center">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2 6L5 9L10 2" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  <span className="text-base md:text-lg text-[#5c4717] font-semibold">{benefit}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="bg-white text-primary border-2 border-primary px-8 py-3 md:px-10 md:py-4 rounded-[5px] font-semibold text-base md:text-lg hover:bg-gray-50 transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-100">
                View Our Shades
              </button>
            </div>
          </div>
